...
//import * as app from 'pdfjs-web/app';

let DEFAULT_URL = 'compressed.tracemonkey-pldi-09.pdf';

if (typeof PDFJSDev !== 'undefined' && PDFJSDev.test('CHROME')) {
  console.log("Rewrite closure");
...
if (typeof PDFJSDev !== 'undefined' && PDFJSDev.test('CHROME || GENERIC')) {
  console.log("Load print service.");
...
function webViewerLoad() {
  ...
  console.log("System load app, gericom, print service")
  ...
  if (typeof PDFJSDev === 'undefined' || !PDFJSDev.test('PRODUCTION')) {
    ...
    console.log("Don't load through system.js");
...
function loadPDFViewer() {
  ...
  if (document.readyState === 'interactive' ||
      document.readyState === 'complete') {
        console.log("Document is interactive and complete.");
    webViewerLoad();
  } else {
    console.log("Else Dom content loaded.");
